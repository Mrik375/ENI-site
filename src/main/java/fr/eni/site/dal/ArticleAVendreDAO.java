...
public interface ArticleAVendreDAO {
	...
	List<ArticleAVendre> findByFiltre(ArticleStatus[] articleStatus, String pseudo, String nomArticle, CategorieArticle categorie, List<Long> idArticles, boolean notPseudo);
}
